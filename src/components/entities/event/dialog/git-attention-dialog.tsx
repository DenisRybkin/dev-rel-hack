...
import { AdderGitAccount } from '../../lk/adder-git-account';
  ...
  return (
    <DialogAdapter isOpen={props.isOpen} onOpenChange={handleOpenChange} >
        ...
        <div className="text-[#000000] text-[16px]">
          К вашему профилю не привязан аккаунт git. Из-за этого шансы на
          одобрение заявки уменьшается, так как мы не сможем увидеть ваше
          портфолио.
        </div>
        <AdderGitAccount />
    </DialogAdapter>
