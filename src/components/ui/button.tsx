...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md !text-small-medium md:!text-base-medium font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300',
  {
    variants: {
      variant: {
        primary:
          'bg-primary-500 text-white hover:bg-primary-500/90 dark:bg-primary-500 dark:text-slate-50 dark:hover:bg-primary-500/90',
        default:
          'border-slate-200 border bg-slate-900 text-primary-500 hover:bg-slate-900/90 dark:bg-dark-3 dark:text-slate-50 dark:hover:bg-dark-4',
        destructive:
        ...
        reset:
          'bg-neutral-300 text-slate-900 hover:bg-slate-100/80 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80',
        ghost:
