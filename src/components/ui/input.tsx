...
const inputVariants = cva(
  'cursor-pointer text-black flex h-10 w-full rounded-md border border-gray focus:border-none bg-white px-3 py-2 text-sm  file:text-blue file:border-0 file:bg-transparent file:text-sm file:font-medium file:!text-primary-500 file:overflow-ellipsis placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-dark-1 dark:placeholder:text-slate-400 ',
  {
    variants: {
      variant: {
        default:
          'ring-offset-white focus-visible:ring-2 focus-visible:ring-gray focus-visible:ring-offset-2 dark:outline-none dark:ring-offset-slate-950 dark:focus-visible:ring-primary-500',
